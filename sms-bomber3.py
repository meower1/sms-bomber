...
#shits not working ddhkdcqujhvLqvaluydvla f
while True:
...
def smsbomb():
    try:
        ...
        print("an SSL error occurred. continuing...")
        pass
    except requests.exceptions.ConnectTimeout:
        print("connection timeout. continuing...")
        pass
        ...
        print("an unexcpected error occured. continuing...")
        pass
